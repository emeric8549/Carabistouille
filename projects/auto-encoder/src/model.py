...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.ConvTranspose1 = nn.ConvTranspose2d(in_channels=128, out_channels=64, kernel_size=3, stride=2, padding=1, output_padding=1)
        self.ConvTranspose2 = nn.ConvTranspose2d(in_channels=64, out_channels=1, kernel_size=3, stride=2, padding=1, output_padding=1)
        self.ConvTranspose3 = nn.ConvTranspose2d(in_channels=64, out_channels=1, kernel_size=3, stride=2, padding=1, output_padding=1)
...
class Decoder_SC(nn.Module):
    def __init__(self):
        ...
        self.ConvTranspose1 = nn.ConvTranspose2d(in_channels=512, out_channels=256, kernel_size=3, stride=2, padding=1, output_padding=1)
        self.ConvTranspose2 = nn.ConvTranspose2d(in_channels=512, out_channels=128, kernel_size=3, stride=2, padding=1, output_padding=1)
        self.ConvTranspose3 = nn.ConvTranspose2d(in_channels=256, out_channels=3, kernel_size=3, stride=2, padding=1, output_padding=1)
...
class Autoencoder_SC(nn.Module):
    def __init__(self):
        ...
        self.encoder = Encoder_SC()
        self.decoder = Decoder_SC()
